...
namespace Tests.Player
{
	...
	{
		private static Game.Players.Old.Player player;

		private static Game.Players.Old.Player InstantiatePlayer()
		{
			var prefab =
				AssetDatabase.LoadAssetAtPath<Game.Players.Old.Player>("Assets/InternalAssets/Prefabs/Player.prefab");
		...
		public sealed class LookingBehaviour
		{
			...
			public void diagonal_mouse_position_rotates_player_in_45_degrees_to_the_right()
			{
				...
				lookBehaviour.PerformLookingAtPosition(lookDirection);
			...
			public void controller_stick_to_the_right_rotates_player_to_the_right()
			{
				...
				lookBehaviour.PerformLookingInDirection(lookDirection);
			...
			public void zero_controller_stick_direction_does_not_change_rotation()
			{
				...
				lookBehaviour.PerformLookingInDirection(Vector2.zero);
